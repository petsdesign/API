...
``` js
{
	...
	"nameReceiver": "펫츠디자인", //[Required]
	//수령자: 2글자 이상의 수령자 이름
	
	"phoneReceiver": "010-1234-5678", //[Required]
	//수령자 전화번호1
	
	"mobileReceiver": "010-1234-5678", //[Required]
	//수령자 전화번호2
	
	"zipCode": "12345", //[Required]
	//(구/신)우편번호: 5자리 이상의 구 우편번호 또는 신 우편번호
	
	"address": "경기도 화성시 팔탄면 버들로 1362번길 10-12", //[Required]
	//(지번/도로명)주소: 주소정재 API를 이용하기 때문에 가급적 신주소로 요청하시기 바랍니다.
	
	"address2": "펫츠디자인", //[Required]
